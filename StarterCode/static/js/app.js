...
function getMetadata(id) {
    ...
    d3.json('../data/samples.json')
        .then(data => {
            ...
            // Clear metadata before displaying new selection data
...
function getBubble(id) {
    ...
    d3.json('../data/samples.json')
     .then(data => {
        ...
        // Render the plot to the div tag with 'bubble'
            ...
            var data = [
                {
                    ...
                    gauge: {
                        ...
                        steps: [
                            ...
                            { range: [2, 3], color: '#82bb9d'},
                            { range: [3, 4], color: '#61aa86'},
                            { range: [4, 5], color: '#368763'},
                            { range: [5, 6], color: '#3d9970'},
                            { range: [6, 7], color: '#2e7555'},
                            { range: [7, 8], color: '#276248'},
                            { range: [8, 9], color: '#121d17'}
                        ],
                    },
                },
            ];
